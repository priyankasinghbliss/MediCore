...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full flex items-center justify-between text-sm py-4 mb-5 ${
        isScrolled ? "bg-secondary shadow-md" : "bg-transparent"
      }  text-white px-5 sm:px-10 md:px-20 lg:px-45 fixed top-0 left-0 z-50 transition-all duration-500`}
    >
      <img
